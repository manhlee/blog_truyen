            ...
            <div class="col-lg-9">
              <div class="card themmoi">
                ...
                <div class="card-body">
                  ...
                  @endif
                      <form action="{{route('post-add-category-story')}}" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="category-name" placeholder="Nhập tên thể loại truyện" name="category_name">
                        </div>                                  
